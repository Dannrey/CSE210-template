public class Address{
    ...
    public Address(){
        ...
        Console.Write("What city does the event take place in? ");
        _city = Console.ReadLine();
        Console.Write("What is the street address of the event? ");
